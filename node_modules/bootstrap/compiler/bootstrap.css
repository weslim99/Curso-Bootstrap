...
.form-control:focus {
  ...
  border-color: #f6b0d0;
  outline: none;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(232, 62, 140, 0.25);
}
...
.btn:not([disabled]):not(.disabled):active, .btn:not([disabled]):not(.disabled).active {
  background-image: none;
  box-shadow: 0 0 0 0.2rem rgba(232, 62, 140, 0.25), inset 0 3px 5px rgba(0, 0, 0, 0.125);
}
...
.btn-primary:focus, .btn-primary.focus {
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(0, 0, 255, 0.5);
}
...
.custom-control-input:active ~ .custom-control-indicator {
  color: #fff;
  background: #fbddeb linear-gradient(180deg, #fce2ee, #fbddeb) repeat-x;
  box-shadow: none;
}
...
.custom-file-input:focus ~ .custom-file-control {
  box-shadow: 0 0 0 0.075rem #fff, 0 0 0 0.2rem #0000FF;
}
